...
export const ResetIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.181-3.183m-4.991-2.691L14.023 3.348m0 0h-4.992m4.992 0l-3.181 3.183a8.25 8.25 0 01-11.664 0l-3.181-3.183" />
  </svg>
);
...
export const SaveIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 16.5V13.5A2.25 2.25 0 0013.5 11.25h-2.25a2.25 2.25 0 00-2.25 2.25v3M12 16.5h.008v.008H12v-.008z" />
    </svg>
);
...
export const TruckIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.125-.504 1.125-1.125V14.25m-17.25 4.5v-9m17.25 9v-9m-17.25-1.5a1.5 1.5 0 011.5-1.5h12a1.5 1.5 0 011.5 1.5v6.75m-15-6.75v-1.5a1.5 1.5 0 011.5-1.5h1.5" />
    </svg>
);
...
export const GiftIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 11.25v8.25a2.25 2.25 0 01-2.25 2.25H5.25a2.25 2.25 0 01-2.25-2.25v-8.25M12 15v6M12 3v6m0 0H9m3 0h3m-3 0a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);
...
export const QrCodeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 6.75h.008v.008H6V6.75zM6 16.5h.008v.008H6v-.008zM16.5 6.75h.008v.008H16.5V6.75zM16.5 16.5h.008v.008H16.5v-.008zM13.5 13.5h.008v.008H13.5v-.008zM13.5 19.5h.008v.008H13.5v-.008zM19.5 13.5h.008v.008H19.5v-.008zM19.5 19.5h.008v.008H19.5v-.008z" />
    </svg>
);
