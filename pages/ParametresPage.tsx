...
const ParametresPage: React.FC<ParametresPageProps> = ({ activeSubMenu, currentUserLevel, isReadOnly = false, onSaveSuccess }) => {
    ...
    const showSaveButton = ![SubMenuId.ParametresDonnees, SubMenuId.ParametresDanger, SubMenuId.ParametresAssistant].includes(activeSubMenu || SubMenuId.ParametresGeneraux);
